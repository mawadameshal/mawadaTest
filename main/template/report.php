...
<html lang="en">
	...
	if(isset($_POST['generte'])) 
	{
		...
		if(empty($varCountry)) 
		{
			$errorMessage = "<li>You forgot to select Assessment Type!</li>";
		}
		...
		else 
		{
			...
			switch($varCountry)
			{
			    case "sms": header("location:stumark.php"); break;
				case "ae": header("location:assessexam.php"); break;
				case "res": header("location:result.php"); break;
				case "ma": header("location:markaudit.php"); break;
                    ...
                    <div class="col-md-6" id="sec1">
                        ...
                        <a href="" class="panel-minimize tooltips" data-toggle="tooltip" title="Minimize Panel"><i class="fa fa-minus"></i></a>
                         <a href="" class="panel-close tooltips" data-toggle="tooltip" title="Close Panel"><i class="fa fa-times"></i></a>
                                        ...
                                        <p>Determine Semester ,Course , Section and type of Reports.</p>
                                    </div><!-- panel-heading -->
                                  ...
                                  <div class="panel-body">  
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <select id="type" name="formCountry" data-placeholder="Choose One" class="width100p" required>
                                                <option value="">Choose one</option>
                                                <option value="sms">Student Marks Schedule</option>
                                                <option value="ae">Assessment and Examination</option>
                                                <option value="res">Results</option>
                                                <option value="ma">Marks Audit</option>
                           ...
                           <div class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3" align="right">
                                                <button type="submit" class="btn btn-primary mr5" name="generte">Generate Report</button>
