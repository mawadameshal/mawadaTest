...
?>
                ...
                <div class="mainpanel">
                    <div class="pageheader">
                        <div class="media">
                            ...
                            <div class="media-body">
                                ...
                                <h4>Calculate Mid Exam Marks</h4>
                            </div>
                        </div><!-- media -->
                    </div><!-- pageheader -->
                   ...
                   <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Calculate Mid Exam Marks</h4>
	...
	$updatesql = "UPDATE `student_all_marks` SET `mid_mark`=('".$_POST['midmark'][$key]."') WHERE (student_mark_id= ".$_POST['ass'][$key].")";
 ...
 # Prepare the SELECT Query
  ...
  $selectSQL = "SELECT * ,  sum(mid1 + mid2) as Total FROM student,student_all_marks WHERE (student_all_marks.student_id=student.student_id) AND (semester_id='".$_SESSION['sem']."') AND (section='".$_SESSION['sec']."') AND (course_id='".$_SESSION['cou']."') group by student_all_marks.student_id ";
...
echo "<tr><td >{$row['student_mark_id']}<input name='ass[]' type='hidden' value='{$row['student_mark_id']}'/></td><td>{$row['student_name']}</td><td>{$row['student_id']}<input name='std[]' type='hidden' value='{$row['student_id']}'/></td><td>{$row['mid1']}<input name='midmark1[]' type='hidden' value='{$row['mid1']}'/></td><td>{$row['mid2']}<input name='midmark2[]' type='hidden' value='{$row['mid2']}'/></td><td><input  class='width100p' required name='midmark[]' type='hidden' value='{$row[Total]}'/>{$row[Total]}</td></tr>";
