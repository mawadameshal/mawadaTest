...
<html lang="en">
	...
	$updatesql = "UPDATE `student_all_marks` SET `lab2`=('".$_POST['labmark'][$key]."') WHERE (student_mark_id= ".$_POST['labass'][$key].")";
...
<table id="basicTable" class="table table-striped table-bordered responsive">
                                <thead class="">
                                    <tr>
                                        ...
                                        <th>Student Name</th>
                                        <th>Student ID</th>
                                        <th>Lab Assessment No.2 Mark</th>
                                             </tr>
                                </thead>
