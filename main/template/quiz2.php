...
<html lang="en">
	...
	$updatesql = "UPDATE `student_all_marks` SET `quiz2`=('".$_POST['quizmark'][$key]."') WHERE (student_mark_id= ".$_POST['quizass'][$key].")";
...
<table id="basicTable" class="table table-striped table-bordered responsive">
                                <thead class="">
                                    <tr>
                                        ...
                                        <th>Student Name</th>
                                        <th>Student ID</th>
                                        <th>Quiz Assessment No.2 Mark</th>
                                             </tr>
                                </thead>
    ...
    <?php
      ...
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          echo "<tr><td>{$row['student_mark_id']}<input name='quizass[]' type='hidden' value='{$row['student_mark_id']}'/></td><td>{$row['student_name']}</td><td>{$row['student_id']}<input name='std[]' type='hidden' value='{$row['student_id']}'/></td><td contenteditable><select select name='quizmark[]' class='width100p' required><option>{$row['quiz2']}</option><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option><option value='5'>5</option></select></td></tr>";
