...
<html lang="en">
                ...
                <div class="mainpanel">
                   ...
                   <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Lab Assessment</h4>
	...
	$updatesql = "UPDATE `student_all_marks` SET `lab1`=('".$_POST['labmark'][$key]."') WHERE (student_mark_id= ".$_POST['labass'][$key].")";
...
<table id="basicTable" class="table table-striped table-bordered responsive">
                                <thead class="">
                                    <tr>
                                        ...
                                        <th>Student Name</th>
                                        <th>Student ID</th>
                                        <th>Lab Assessment No.1 Mark</th>
                                             </tr>
                                </thead>
    ...
    <?php
      ...
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          echo "<tr><td>{$row['student_mark_id']}<input name='labass[]' type='hidden' value='{$row['student_mark_id']}'/></td><td>{$row['student_name']}</td><td>{$row['student_id']}<input name='std[]' type='hidden' value='{$row['student_id']}'/></td><td contenteditable><select select name='labmark[]' class='width100p' required><option>{$row['lab1']}</option><option value='1'>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option><option value='5'>5</option></select></td></tr>";
