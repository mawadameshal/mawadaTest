...
<html lang="en">
      ...
      <div class="pull-right">
            ...
            <div class="mainwrapper">
                ...
                <div class="mainpanel">
                   ...
                   <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Mid Examination</h4>
       		...
       		foreach($_POST['std'] as $key => $std){
       			...
       			if ($_POST['mrks'][$key] <= 20){
      			
	$updatesql = "UPDATE `student_all_marks` SET `mid2`=('".$_POST['mrks'][$key]."') WHERE (student_mark_id= ".$_POST['midexam'][$key].")";
	$result3 = mysql_query($updatesql) or die("<br/><br/>".mysql_error());
	 	 ...
	 	 echo '<tr><td colspan="4">Mid Mark Should be Less or equals 20</td></tr>';
	 	  		   }
    ...
    <?php
      ...
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          echo "<tr><td>{$row['student_mark_id']}<input name='midexam[]' type='hidden' value='{$row['student_mark_id']}'/></td><td>{$row['student_name']}</td><td>{$row['student_id']}<input name='std[]' type='hidden' value='{$row['student_id']}'/></td><td  contenteditable><input class='width100p' required name='mrks[]' value='{$row['mid2']}'/></td></tr>";
