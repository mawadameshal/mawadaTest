...
<html lang="en">
	...
	if(isset($_POST['formadd'])) 
	{
        ...
        case "lab1": header("Location: lab1.php"); break;
        case "lab2": header("Location: lab2.php"); break;
				case "quiz1": header("Location: quiz1.php"); break;
				case "quiz2": header("Location: quiz2.php"); break;
				case "mid1": header("Location: mid1.php"); break;
				case "mid2": header("Location: mid2.php"); break;
				case "final": header("Location: final.php"); break;
        case 'bonus':header("Location: bonus.php"); break;
                    ...
                    <div class="col-md-6" id="sec1">
                        ...
                        <a href="" class="panel-minimize tooltips" data-toggle="tooltip" title="Minimize Panel"><i class="fa fa-minus"></i></a>
                         <a href="" class="panel-close tooltips" data-toggle="tooltip" title="Close Panel"><i class="fa fa-times"></i></a>
                                  ...
                                  <?php  if($userRow['permission'] == 'entry'){ ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <option value="">Choose One</option>
                                                      <optgroup label=" Lab Assessments">
                                                      <option value="lab1">Lab No.1</option>
                                                      <option value="lab2">Lab No.2</option>
                                                          </optgroup>
                                                          
                                                      <optgroup label=" Quiz Assessments">
                                                      <option value="quiz1">Quiz No.1</option>
                                                      <option value="quiz2">Quiz No.2</option>
                                                          </optgroup>
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <option value="">Choose One</option>
                                                      ...
                                                      <option value="quiz2">Quiz No.2</option>
                                                        ...
                                                        <optgroup label="Mid Examinations">
                                                        <option value="mid1">Mid No.1</option>
                                                        <option value="mid2">Mid No.2</option>
                                                            </optgroup>

                                                            <option value="bonus" label="Bonus Mark">Bonus Mark</option>
                                                            
                                                          <option value="final" label="Final Examination">Final Examination</option>  
                           ...
                           <div class="panel-footer">
                                        <div class="row">
                                            <div class="col-sm-9 col-sm-offset-3" align="right">
                                                <button type="submit" class="btn btn-primary mr5" name="formadd">Add Marks</button>
