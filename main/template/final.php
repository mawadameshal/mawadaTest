...
<html lang="en">
      ...
      <div class="pull-right">
            ...
            <div class="mainwrapper">
                ...
                <div class="mainpanel">
                   ...
                   <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Final Examination</h4>
       		...
       		foreach($_POST['std'] as $key => $std){
       			...
       			if ($_POST['mrks'][$key] <= 40){
      			
	$updatesql = "UPDATE `student_all_marks` SET `final`=('".$_POST['mrks'][$key]."') WHERE (student_mark_id= ".$_POST['fexam'][$key].")";
	$result3 = mysql_query($updatesql) or die("<br/><br/>".mysql_error());
	 	 ...
	 	 echo '<tr><td colspan="4">Final Mark Should be Less or equals 40</td></tr>';
	 	  		   }
    ...
    <?php
      ...
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          echo "<tr><td>{$row['student_mark_id']}<input name='fexam[]' type='hidden' value='{$row['student_mark_id']}'/></td><td>{$row['student_name']}</td><td>{$row['student_id']}<input name='std[]' type='hidden' value='{$row['student_id']}'/></td><td  contenteditable><input class='width100p' required name='mrks[]' value='{$row['final']}'/></td></tr>";
