...
<html lang="en">
                ...
                <div class="mainpanel">
                   ...
                   <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Final Examinations</h4>
	...
	$updatesql = "UPDATE `final_exam` SET `mark`=('".$_POST['mrks'][$key]."') WHERE (final_id = ".$_POST['final'][$key].")";
 ...
 # Prepare the SELECT Query
  ...
  $selectSQL = "SELECT * FROM student,final_exam WHERE (final_exam.student_id=student.student_id) AND (semester_id='".$_SESSION['sem']."') AND (section='".$_SESSION['sec']."') AND (course_id='".$_SESSION['cou']."') order by final_exam.student_id ";
    ...
    <?php
      ...
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          echo "<tr><td>{$row['final_id']}<input name='final[]' type='hidden' value='{$row['final_id']}'/></td><td>{$row['student_name']}</td><td>{$row['student_id']}<input name='std[]' type='hidden' value='{$row['student_id']}'/></td><td contenteditable><input name='mrks[]' value='{$row['mark']}'/></td></tr>";
