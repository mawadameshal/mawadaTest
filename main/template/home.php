 ...
 <div class="contentpanel">
                        ...
                        <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Welcome To Insert Marks Page</h4>
...
<table id="basicTable" class="table table-striped table-bordered responsive">
                                <thead class="">
                                    <tr>
                                        <th class="text-center">Instructions for you to insert marks into System</th>
                                    </tr>
                                </thead>
                                ...
                                <tr>
                                    <td>1. Press on Inserting and Updating Mark on the sidebar</td>
                                </tr>
                                <tr>
                                    <td>2. Select from the form appear and then click Add button</td>
                                </tr>
...
?>
    ...
    <div class="contentpanel single">
                        
                        <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Lectures Schedule</h4>
 ...
 # Prepare the SELECT Query
  $selectSQL = " SELECT course_name, lecture_schedule.course_id, day, time, class from course, lecture_schedule WHERE lecture_schedule.course_id=course.course_id AND `lecture_id`=".$_SESSION['user'];
    ...
    <?php
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        while( $row = mysql_fetch_assoc( $selectRes ) ){
          echo "<tr><td>{$row['course_name']}</td><td>{$row['course_id']}</td><td>{$row['day']}</td><td>{$row['time']}</td><td>{$row['class']}</td></tr>\n";
        }
      }
    ?>
  </tbody>
