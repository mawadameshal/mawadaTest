                ...
                <div class="mainpanel">
                   ...
                   <div class="panel panel-primary-head">
                            <div class="panel-heading">
                                <h4 class="panel-title">Student Marks Schedule for <em><?php 
...
$selectSQL = "SELECT * FROM student,student_all_marks WHERE (student_all_marks.student_id=student.student_id) AND (semester_id='".$_SESSION['semester']."') AND (section='".$_SESSION['section']."') AND (course_id='".$_SESSION['course']."')"; 
...
<table id="basicTable" class="table table-striped table-bordered responsive">
    ...
    <?php
      ...
      if( mysql_num_rows( $selectRes )==0 ){
        ...
        echo "<tr><td>{$row['student_name']}</td><td>{$row['student_id']}</td><td>{$row['assess_mark']}</td><td>{$row['mid_mark']}</td><td>{$row['final']}</td><td>{$row['full_mark']}</td><td>{$row['grade']}</td></tr>";
